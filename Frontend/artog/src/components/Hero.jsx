...
import BG from "../images/BG.jpeg"; // background image
import naru from "../images/naru.png"; // mascot image
    ...
    <section className="relative h-screen w-full flex flex-col items-center justify-center text-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="animate-[float_6s_ease-in-out_infinite] mb-6 mt-[50px] hover:scale-105 transition-transform duration-500">
          <img
            src={naru} // your mascot image
            alt="My Mascot"
            className="w-5/6 md:w-4/5 lg:w-3/4 max-w-4xl h-auto object-contain drop-shadow-[0_40px_100px_rgba(249,115,22,0.85)]"
          />
        </div>
